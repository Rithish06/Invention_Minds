...
const Heroics = () => {
  const heroics_content = [
...

    {
      ...
      experience: "15 ",
      briefProfile: "Mr. Rajesh Yadav has 15 years of experience working in the IT and Healthcare industries. He is widely renowned for his ability to strategically combine artistic strategy with business goals."
    },
...

    {
      ...
      experience: "10",
      briefProfile: "With ten years of experience in content proofreading, S V Reddy ensures that every piece of content meets the highest standards of accuracy and quality. A meticulous approach to detail and a strong command of language are key to maintaining the professional integrity of all communications."
    },
...

    {
      ...
      experience: "9",
      briefProfile: "Ms. Tejaswini is well-known for her strategic acumen; she has successfully linked company goals with creative approaches for the past nine years across a wide range of industries (Healthcare, Education, and Real estate). She successfully steers her team, which is in charge of brand design and marketing strategies for a wide range of clients."
    },
    // {
    //   name : "Surya",
    ...
    },
    {
      ...
      designation: "Full Stack Developer ",
      experience: "7",
      briefProfile: "Ms. Keerthana M is a dynamic Full Stack Developer with seven year of rich experience in developing scalable and efficient web applications. Specializing in Angular, Node.js, Express.js, and MySQL, Keerthana brings a comprehensive skill set that covers both frontend and backend development. Her proficiency in these technologies enables her to craft robust solutions that align with business needs and deliver superior user "
    },
    // {
    //   name: "Aaron Z Philip",
    //   designation: "Graphic Designer ",
    ...
    // },
    {
      ...
      experience: "4",
      briefProfile: "Govindaraj K is a highly skilled and results-oriented Frontend Developer with four years of dedicated experience building dynamic, responsive, and high-performance user interfaces. Specializing in modern JavaScript frameworks, Govindaraj possesses deep expertise in both Angular and ReactJS. His proficiency allows him to effectively choose and implement the best technology solution for complex frontend challenges, ensuring superior user experience (UX) and efficient, scalable code that drives successful web applications."
    },
    {
      name: "Veda V",
      designation: "Graphic Designer",
